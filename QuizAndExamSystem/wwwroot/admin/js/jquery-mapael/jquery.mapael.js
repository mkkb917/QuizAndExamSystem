...
(function (factory) {
    ...
    Mapael.prototype = {
         ...
         *          - Apply translation: take into Account the map offset in the page
         *          ** from this point, we have relative mouse coordinate
         *          - Apply homothetic transformation: take into Account initial factor of map sizing (fullWidth / actualWidth)
         *          - Apply homothetic transformation: take into Account the zoom factor
         *          ** from this point, we have relative map coordinate
         *          - Apply translation: take into Account the current panning of the map
