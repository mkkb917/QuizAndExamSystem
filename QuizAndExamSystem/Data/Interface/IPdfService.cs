...
namespace ExamSystem.Data.Interface
{
    public interface IPdfService
    {
        ...
        Task<PaperViewVM> RenderPaper(int selectedClass, int selectedSubject, DateTime PaperDate, string? TeacherName, ApplicationUser usr);
        Task<byte[]> RenderPdf(string paperView, string fileName, string qrcode);
